      ...
      <div className="space-y-3">
        ...
        <CopyToClipboard>
          <div className="relative group">
            <div className="bg-muted/50 dark:bg-muted/30 border-2 border-dashed border-border rounded-lg hover:border-primary/50 hover:bg-muted/70 transition-all duration-200 cursor-pointer">
              <CopyTrigger textToCopy={successData.password} className="w-full flex items-center justify-between gap-3 p-4">
              ...
              <CopyCopied className="w-full flex items-center justify-between gap-3 p-4">
                <code className="text-lg font-mono font-semibold text-foreground tracking-wide flex-1">
                  {successData.password}
                </code>
                <div className="shrink-0">
