...
export const CopyToClipboard = ({ children, className, textToCopy, onClick }: { children: React.ReactNode, className?: string, textToCopy: string, onClick?: (e: React.MouseEvent<HTMLButtonElement>) => void }) => {
