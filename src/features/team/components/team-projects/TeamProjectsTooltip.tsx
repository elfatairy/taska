...
import { TeamProjectsTooltipSkeleton } from "@/features/team/components/team-projects/TeamProjectsSkeleton";
...
function TeamProjectsTooltipContent({ teamId, projectCount }: { teamId: TeamId, projectCount: number }) {
  ...
  if (!teamProjectsQuery) {
    return <TeamProjectsTooltipSkeleton projectCount={projectCount} />
  }
