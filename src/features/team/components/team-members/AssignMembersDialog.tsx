// TODO refactor with @team-creation/NewTeamFormMembersStep.tsx
...
import { TeamId, TeamMember, User } from "@/common/types"
import { useDialogSearchParams } from "@/common/hooks/useDialogSearchParams"
import { AssignMembersSkeleton } from "./AssignMembersSkeleton"
import { AssignMembersDialogSuccess } from "./AssignMembersDialogSuccess"
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="md:max-w-5xl">
        ...
        {showSuccess ? (
          <AssignMembersDialogSuccess onClose={handleClose} />
        ) : (
...
function SelectedMembersList({ selectedMembers, users, removeMember }: { selectedMembers: string[], users: User[], removeMember: (member: string) => void }) {
  return (
...
function UsersListItem({ user, selectedMembers, teamMembers, addMember, removeMember }: { user: User, selectedMembers: string[], teamMembers: TeamMember[], addMember: () => void, removeMember: () => void }) {
