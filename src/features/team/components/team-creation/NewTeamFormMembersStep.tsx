...
import { NewTeamFormMembersStepSkeleton } from "@/features/team/components/team-creation/NewTeamFormSkeleton";
...
function NewTeamFormMembersStepContent({ selectedMembers, teamLeadId, users, searchValue, addMember, removeMember, setTeamLead }: { selectedMembers: string[], teamLeadId: string | null, users: User[], searchValue: string, addMember: (member: string) => void, removeMember: (member: string) => void, setTeamLead: (leadId: string) => void }) {
...
function SelectedMembersList({ selectedMembers, teamLeadId, users, removeMember, setTeamLead }: { selectedMembers: string[], teamLeadId: string | null, users: User[], removeMember: (member: string) => void, setTeamLead: (leadId: string) => void }) {
...
function UsersListItem({ user, selectedMembers, teamLeadId, addMember, removeMember }: { user: User, selectedMembers: string[], teamLeadId: string | null, addMember: () => void, removeMember: () => void }) {
