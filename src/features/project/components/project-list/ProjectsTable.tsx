...
import { ProjectAssignTeamsDialog, useShouldOpenProjectAssignTeamsDialog } from "@/features/project/components/project-teams/ProjectAssignTeamsDialog"
...
export function ProjectsTable({
  ...
  const shouldOpenProjectAssignTeamsDialog = useShouldOpenProjectAssignTeamsDialog();
  const [openProjectAssignTeamsDialog, setOpenProjectAssignTeamsDialog] = useState(shouldOpenProjectAssignTeamsDialog);
